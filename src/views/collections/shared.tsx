...
// Returns the data-id-safe string from a label/text
// e.g. "Vol. change high to low" -> "vol-change-high-to-low"
export const formatLabelToDataId = (text: string) => {
  const lowerCased = text.toLowerCase();
  const sanitizedSpecialChars = lowerCased.replace(/[^a-zA-Z0-9]/g, "-");
  const removedExtraDashes = sanitizedSpecialChars.replace(/--/g, "-");
  return removedExtraDashes;
};
