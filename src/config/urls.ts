...
export const COLLECTION_IMAGE_PLACEHOLDER_URI = "/images/collection-logo-placeholder.svg";
export const COLLECTION_BANNER_PLACEHOLDER_URI = "/images/collection-banner-placeholder.svg";
