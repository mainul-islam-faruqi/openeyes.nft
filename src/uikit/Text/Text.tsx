...
export const Text = forwardRef<TextProps, "div">(
  ({ bold, fontWeight = fontWeights.normal, textStyle = "body", color = "text-01", ...props }, ref) => (
    <ChakraText
      color={color}
      textStyle={textStyle}
...
export const RainbowText: React.FC<RainbowTextProps> = ({ children, animate, bg = base.conicGradient, ...props }) => {
